...
import hdNode, { network } from '../mock/mock-keys'
...
describe('models/transaction/utils', function () {
  ...
  describe('buildTransaction', function () {
    ...
    console.log('!!! inputA.privateKey = ' + inputA.privateKey.toString('hex'))
    console.log('!!! inputB.privateKey = ' + inputB.privateKey.toString('hex'))
    ...
    console.log('!!! aEcPair.toWIF() = ' + aEcPair.toWIF())
    const inputs = [
    ...
    it('should create a transaction hex (bitcoinjs-lib build)', function () {
      ...
      const expectedHex = ''
      const transactionInfo = buildTransactionOld('BTC')(inputs, outputs, network)
