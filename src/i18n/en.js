export default {
  ...
  dealFlowMessageContentCollectEquibits: 'You can now collect the securities:',
  ...
  securitiesCollectionTimeLeftDescriptionEquibits: 'Time left to collect the equibits',
