...
Cypress.Commands.add('addOrders', (type, numberOfOrders=0) => {
  Cypress.log({
    name: 'addOrders'
  })
  ...
  if (fillPages) {
    ...
    switch(type) {
      ...
      case 'archived':
        cy.exec(
          'mongo wallet_api-testing --eval \'db.orders.insertMany('
          + '[ {"assetType":"EQUIBIT","btcAddress":"","eqbAddress":"mz7H5JeoRBYJxizgzuxRMPa95asdzixqCc","portfolioId":"5ba8fc09347fab2cb9dd8ecf","type":"SELL","quantity":10000,"price":100000000,"isFillOrKill":true,"goodFor":1,"status":"CANCELLED","userId":ObjectId("5ba8fbf5347fab2cb9dd8ecc"),"__v":0},'
